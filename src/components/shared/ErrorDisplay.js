        ...
        <div className="error-message">
            ...
            {error.includes(ERROR_TYPES.ENV_VAR_MISSING) && (
                <div className="env-help">
                    ...
                    <p>To use this functionality, you need to set the following environment variables:</p>
                    <ul>
                        <li><code>{ENV_VARS.API_KEY}</code> - Your Printful API key</li>
                        <li><code>{ENV_VARS.STORE_ID}</code> - Your Printful store ID</li>
                    </ul>
