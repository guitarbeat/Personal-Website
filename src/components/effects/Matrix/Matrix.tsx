    ...
    class Drop {
      ...
      draw(ctx: CanvasRenderingContext2D) {
        ...
        this.trail.forEach((trailItem, index) => {
          ...
          // Performance optimization: Use solid color instead of gradient to reduce GC pressure
          // const gradient = ctx.createLinearGradient(...)

          ctx.fillStyle = `rgba(0, 220, 0, ${trailOpacity * 0.7})`;
        ...
        // Performance optimization: Use solid color instead of gradient
        ...
        if (this.brightness) {
          ...
          ctx.fillStyle = `rgba(0, 255, 75, ${this.opacity * 0.85})`;
