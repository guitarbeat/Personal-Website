...
function Projects(props) {
  ...
  const projects = useMemo(
    () => normalizeSheetData(props.db, "projects"),
    [props.db],
  );
  ...
  useEffect(() => {
    ...
    const generatedTagColors = generateItemColors(projects, "keyword");
  ...
  useEffect(() => {
    ...
    const handleThemeChange = () => {
      ...
      const regeneratedTagColors = generateItemColors(projects, "keyword");
