    ...
    class Drop {
      ...
      draw(ctx: CanvasRenderingContext2D) {
        ...
        this.trail.forEach((trailItem, index) => {
          ...
          // Performance optimization: Use solid colors instead of gradients for trails
          // This saves creating hundreds of CanvasGradient objects per frame
        ...
        // Performance optimization: Use solid colors instead of gradients
        // This significantly reduces garbage collection and render time
        if (this.brightness) {
