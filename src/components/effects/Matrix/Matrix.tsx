    ...
    class Drop {
      ...
      draw(ctx: CanvasRenderingContext2D) {
        ...
        this.trail.forEach((trailItem, index) => {
          ...
          // Bolt Optimization: Replaced expensive gradient creation with solid colors
          // This reduces GC pressure significantly for the hundreds of drops
        ...
        if (this.brightness) {
          ...
          // Bolt Optimization: Solid color instead of gradient
