/*! For license information please see main.866be551.js.LICENSE.txt */
(() => {
	var e = {
			2730: (e, n, t) => {
				var r = t(5043),
						...
						movementX: (e) =>
							"movementX" in e
								...
								: (e !== it &&
										...
										(it = e)),
									ot),
						movementY: (e) => ("movementY" in e ? e.movementY : ut),
					}),
					ht = at(pt),
							...
							if (
								...
								if (
									...
									e: {
										...
										while (0 < h - p) (c = qr(c)), h--;
										while (0 < p - h) (d = qr(d)), p--;
										while (h--) {
				...
				var rl = "function" === typeof setTimeout ? setTimeout : void 0,
					...
					ol =
						"function" === typeof queueMicrotask
							? queueMicrotask
							: "undefined" !== typeof al
								? (e) => al.resolve(null).then(e).catch(ul)
								: rl;
				function ul(e) {
					setTimeout(() => {
						throw e;
				...
				function fa(e) {
					...
					if (
						...
						while (n) oa(e, n), (n = sl(n.nextSibling));
					}
					if ((ca(e), 13 === e.tag)) {
					...
					function m(l, a, u, i) {
						...
						for (f = r(l, f); m < u.length; m++)
							null !== (v = h(f, l, m, u[m], i)) &&
								...
								(c = v));
						return e && f.forEach((e) => n(l, e)), la && Zl(l, m), s;
					}
					function v(l, u, i, s) {
						var c = O(i);
						...
						for (m = r(l, m); !y.done; v++, y = i.next())
							null !== (y = h(m, l, v, y.value, s)) &&
								...
								null === f ? (c = y) : (f.sibling = y),
								(f = y));
						return e && m.forEach((e) => n(l, e)), la && Zl(l, v), c;
					}
				...
				var Zo = {
					...
					Jo = {
						readContext: Ta,
						useCallback: (e, n) => (
							(yo().memoizedState = [e, void 0 === n ? null : n]), e
						),
						useContext: Ta,
						useEffect: Oo,
						...
						useLayoutEffect: (e, n) => Mo(4194308, 4, e, n),
						useInsertionEffect: (e, n) => Mo(4, 2, e, n),
						useMemo: (e, n) => {
							var t = yo();
							return (
								(n = void 0 === n ? null : n),
						...
						useRef: (e) => ((e = { current: e }), (yo().memoizedState = e)),
						useState: To,
						useDebugValue: Vo,
						useDeferredValue: (e) => (yo().memoizedState = e),
						useTransition: () => {
							var e = To(!1),
								n = e[0];
							return (
					...
					eu = {
						...
						useState: () => wo(ko),
						useDebugValue: Vo,
						useDeferredValue: (e) => Ho(bo(), uo.memoizedState, e),
						useTransition: () => [wo(ko)[0], bo().memoizedState],
						useMutableSource: Eo,
					...
					nu = {
						...
						useTransition: () => [So(ko)[0], bo().memoizedState],
						useMutableSource: Eo,
						useSyncExternalStore: xo,
						useId: Qo,
						unstable_isNewReconciler: !1,
				...
				var lu = {
					isMounted: (e) => !!(e = e._reactInternals) && $e(e) === e,
										...
										(i = (o = Zu).child),
											22 === o.tag && null !== o.memoizedState
												...
												: null !== i
													? ((i.return = o), (Zu = i))
													: Si(l);
								while (null !== a) (Zu = a), bi(a, n, t), (a = a.sibling);
								(Zu = l), (Yu = u), (Xu = s);
							}
							ki(e);
						} else
				...
				(Ys.prototype.render = Ks.prototype.render =
					...
					(Ys.prototype.unstable_scheduleHydration = (e) => {
						if (e) {
							var n = _n();
				...
				var ec = {
					...
					tc = {
						...
						findFiberByHostInstance: nc.findFiberByHostInstance || (() => null),
						...
						new Promise((n, r) => {
							...
							((e, n, r, l, a) => {
								...
								(o.rel = "stylesheet"),
									...
									(o.onerror = o.onload =
										(t) => {
											if (((o.onerror = o.onload = null), "load" === t.type))
												l();
											else {
												var r = t && t.type,
	...
	var r = t(5043),
		...
		a = t(579);
	const o = (0, r.lazy)(() =>
			Promise.all([t.e(524), t.e(68)]).then(t.bind(t, 9759)),
		),
		u = (0, r.lazy)(() => t.e(469).then(t.bind(t, 6469))),
		...
		(0, l.H)(i).render(
			(0, a.jsx)(r.StrictMode, {
				children: (0, a.jsx)(r.Suspense, {
					fallback: null,
					children: (0, a.jsx)(u, { children: (0, a.jsx)(o, {}) }),
				}),
			}),
		);
	} catch (s) {
		console.error("Failed to initialize React application:", s),
			(i.innerHTML =
				'<div style="color: red; padding: 20px;">Failed to load application. Please refresh the page.</div>');
	}
})();
//# sourceMappingURL=main.866be551.js.map
